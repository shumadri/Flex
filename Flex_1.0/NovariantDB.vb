...
Public Class NovariantDB
    ...
    Private Sub NovariantDB_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim da As New OleDbDataAdapter("SELECT * FROM Novariant", cnn)
    ...
    Public Sub SQLUPdateCambium()
        ...
        Try
            ...
            actualizar = "UPDATE Novariant SET status='" & txtpastdue.Text & "' WHERE ID=" & txtID.Text & " "
